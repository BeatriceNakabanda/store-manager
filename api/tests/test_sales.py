...
class Test_Sales(unittest.TestCase):
    def setUp(self):
        ...
        self.new_record = Sales(5, "floral blouse", "75000", "20", "150000", "Tue, 16 Oct 2018 18:42:38 GMT")
    ...
    def test_sold_pdt_quantity(self):
        ...
        self.assertEqual(self.new_record.quantity, "20")
        self.assertNotEqual(self.new_record.quantity, "23")
        self.assertNotEqual(self.new_record.quantity, "32")
