...
class TestProduct(unittest.TestCase):
    def setUp(self):
        self.product = Product(1, 5, 50000, "Slim Mom Jeans","Tue, 16 Oct 2018 18:42:38 GMT")
    ...
    def test_product_quantity(self):
        ...
        self.assertEqual(self.product.quantity, 5, "Quantity should be 5")
    ...
    def test_date_added(self):
        ...
        self.assertEqual(self.product.date_added,'Tue, 16 Oct 2018 18:42:38 GMT')
